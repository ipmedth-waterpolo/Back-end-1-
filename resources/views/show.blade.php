    ...
    <div class="container my-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p class="card-text"><strong>Beschrijving:</strong> {{ $training->beschrijving }}</p>
                <p class="card-text"><strong>Totale Duur:</strong> {{ $training->totale_duur }} minuten</p>
            </div>
        </div>

        <!-- Oefeningen van de Training -->
        <h2>Oefeningen</h2>
        <div class="row">
